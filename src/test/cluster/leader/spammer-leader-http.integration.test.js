...
const closeFunc = jest.fn().mockResolvedValue();
const createTable = jest.fn().mockResolvedValue({});

const persistenceClientMock = {
    close: closeFunc,
...
describe('API Tests', () => {
    ...
    beforeEach(() => {
        spammerLeaderInstance = new SpammerLeaderHttp('0.0.0.0', spammerPort, persistenceClientMock);
    });
